...
var centerXc = 1295;  // CONTROL CIRCLE OF CARBON SEQUESTRATION
var centerYc = 450;
var Rc = 300;
var rc = 200;
...
function calculate()
{
    ...
    for(i=0; i<dots.length; i++)
    {
        ...
        var px = image1x_ar[index] + 800;  //POSITION OF WORLD MAP HORIZONTALLY
        var py = image1y_ar[index] + 200;  //POSITION OF WORLD MAP VERTICALLY
        if(i>0)
        {
            for(let j=0; j<i; j++)
            {
...
function calculate2()
{
    ...
    for(i=0; i<(dot1.length); i++)
    {
            ...
            var addpx = 250;  //CONTROL HORIZONTAL POSITION OF BUBBLE
            var addpy = 100;  //CONTROL VERTICAL POSITION OF BUBBLE
            ...
            if((distance(centerX, centerY, posx, posy) < R) && (distance(centerX, centerY, posx, posy) > r))
            {
                if(i>0)
                {
                    ...
                    if(temp==1)
                    {
                        image2_class1_posx[i] = posx+addpx;
                        image2_class1_posy[i] = posy+addpy;
                    }
                    else
                    {
                        temp = 1;
                ...
                {
                    image2_class1_posx[0] = posx+addpx;
                    image2_class1_posy[0] = posy+addpy;
                }
            }
            else
            {
    ...
    for(i=0; i<(dot2.length); i++)
    {
            ...
            if(distance(centerX, centerY, posx, posy) < (r-5))
            {
                if(i>0)
                {
                    ...
                    if(temp==1)
                    {
                        image2_class2_posx[i] = posx+addpx;
                        image2_class2_posy[i] = posy+addpy;
                    }
                    else
                    {
                        temp = 1;
...
function show12()
{
    ...
    dots[0].style.left = 1200 + 'px';
    dots[0].style.top = 350 + 'px';
